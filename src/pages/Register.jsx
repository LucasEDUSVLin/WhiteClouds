...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // 2. Salvar os dados do perfil no Firestore usando o UID do usuário como ID do documento
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md p-8 bg-white border border-slate-200 rounded-xl shadow-2xl space-y-6">
        ...
        <p className="text-sm text-center text-slate-600">Crie sua conta para começar</p>
